...
## Build Instructions
### Prerequisites
First you will need to build a compiler. You can find instructions for doing this at https://wiki.osdev.org/Building_GCC.  
You will need an i686-elf C (GCC) compiler to build this project.

Additionally, to compile ELF programs for TritiumOS you will need the i686-tritium compiler to build this project.  
You can build one using the [tritium-compiler](https://github.com/foliagecanine/tritium-compiler) repository.  
You will also need to install the C/C++ libraries using the [libc-tritium](https://github.com/foliagecanine/libc-tritium/tree/rewrite) repository.
...
You can also mount two drives to the virtual machine using the ahci-qemu2.sh script as below:  
...
## How do I write programs for TritiumOS?
For information on writing programs for TritiumOS, see [prgms/docs/COMPILING.md](prgms/docs/COMPILING.md)

## What if I just want to use the ISO?
You can use the bootable .iso file in the root of this repository and run it in a virtual machine.
...
## Contributing
This software likely has many bugs, and is missing several features of modern OSes.
Contributors are welcome to fork this repository and submit pull requests.
