...
void setpixel(uint32_t x, uint32_t y, color32 c) {
...
void rect(uint32_t x, uint32_t y, uint32_t w, uint32_t h, color32 c) {
...
void draw_str(uint32_t x, uint32_t y, char *str, color32 back_color, color32 front_color) {
	char *cstr = str;
	while (*cstr) {
...
int main(int argv, char *argc[]) {
	...
	draw_str(4, framebuffer_height - 12, "Hello World!", (color32){200, 200, 200, 0}, (color32){0, 0, 0, 0});
	drawframe();
}
