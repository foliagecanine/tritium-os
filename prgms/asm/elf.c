...
elfhdr32 default_elf_header = {.magic = {0x7F, 'E', 'L', 'F'}, .arch_class = 1, .arch_endian = 1, .file_version = 1, .os_abi = 0, .abi_version = 0, .pad = {0}, .type = 2, .arch_target = 3, .elf_version = 1, .entrypoint = 0x8040000, .ph_offset = sizeof(elfhdr32), .sh_offset = 0, .flags = 0, .header_size = sizeof(elfhdr32), .ph_size = sizeof(elfph32), .ph_num = 1, .sh_size = 0, .sh_num = 0, .sh_string_index = 0};

elfph32 default_program_header = {.type = 1,
