...
uint64_t getLocationFromCluster(uint32_t clusterNum, FAT12_MOUNT fm) { return (uint64_t)((clusterNum - 2) * 512) + (fm.NumRootDirectoryEntries * 32) + (fm.RootDirectoryOffset * 512); }
